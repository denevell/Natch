...
public class PostEditModelImpl implements PostEditModel {
  ...
  public int edit(final long id, final String username,
      final PostEntity editedPostEntity, final boolean adminEditing) {
    try {
      int result = mPostModel.startTransaction().updateEntityOnPermission(id,
